...
ppp = Path("yomitori")
df = pd.read_excel('yomitori/C0008-04_全データ回帰分析強化版変更へんい.xlsx', sheet_name='Sheet1')
nmp=df.to_numpy()
syudan = nmp
...
aaa = Path("hozon")
anim.save(aaa/'C0008-04比較用.gif', writer='writer', fps=2)
