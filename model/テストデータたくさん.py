...
ppp = Path("yomitori")
df = pd.read_excel('yomitori/iiyatu_test12.xlsx', sheet_name='Sheet3')
nmp=df.to_numpy()
syudan = nmp
...
aaa = Path("hozon")
anim.save(aaa/'テスト回帰分析2.gif', writer='writer', fps=2)
