...
import random
import math
from moussaif import fa_dasukai,fa_dasukai2, hulistics_1, hulistics_1_kai,cal_fij, cal_fiw , dasu_v_1d, dvdt , alpha_dasu,mokutekiti_siro, alpha_kousin, syouhan
...
ppp = Path("yomitori")
df = pd.read_excel('model/yomitori/C0008-01_全データ回帰分析強化版変更へんい.xlsx', sheet_name='Sheet1')
nmp=df.to_numpy()
syudan = nmp
...
im = Image.open("model/oudan_2.png")
...
aaa = Path("model/hozon")
anim.save(aaa/'C0008-01_全データ回帰分析強化版変更へんい2222.gif', writer='writer', fps=2)
