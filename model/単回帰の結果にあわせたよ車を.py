...
import random
import math
from moussaif import fa_car,fa_kekka,fa_dasukai2, hulistics_1, cal_fij, cal_fiw , dasu_v_1d, dvdt , alpha_dasu,mokutekiti_siro, alpha_kousin, syouhan
...
for j in zikan:
    ...
    for l in range(n_gen):
        if fa_syucar[l] < 10:
            print(fa_syucar[l],"車のfaはちゃんと計算されてる")
...
aaa = Path("hozon")
anim.save(aaa/'zikkou_短歌行き車1202.gif', writer='writer', fps=2)
