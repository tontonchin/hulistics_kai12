...
import random
import math
from moussaif import fa_dasukai,fa_dasukai2, hulistics_1, cal_fij, fa_car , dasu_v_1d, fa_kekka , alpha_dasu,mokutekiti_siro, alpha_kousin, syouhan
...
aaa = Path("hozon")
anim.save(aaa/'teatsampke120403car.gif', writer='writer', fps=2)
